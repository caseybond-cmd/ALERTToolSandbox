    ...
    function populateStaticContent() {
        ...
        document.getElementById('scoringContainer').innerHTML = `<h2 class="text-xl font-bold border-b pb-3 mb-4">Clinical Risk Factors</h2>
            <div class="space-y-2">
                ...
                <div><label class="block font-medium mb-1">Baseline Patient Factors:</label><div class="pl-2 border-l-2 space-y-2"><select id="age" class="score-input w-full rounded-md border-2 p-2"><option value="0">Age ≤ 65</option><option value="1">Age > 65</option></select>${buildNote('age')}<select id="admission_type" class="score-input w-full rounded-md border-2 p-2"><option value="0">Surgical (Elective)</option><option value="1">Surgical (Emergency)</option><option value="2">Medical or ED</option></select>${buildNote('admission_type')}<select id="los_days" class="score-input w-full rounded-md border-2 p-2"><option value="0">ICU LOS ≤ 5 days</option><option value="1">ICU LOS > 5 days</option></select>${buildNote('los_days')}<select id="severe_comorbidities" class="score-input w-full rounded-md border-2 p-2"><option value="0">Comorbidities < 2</option><option value="2">Severe Comorbidities ≥ 2</option></select>${buildNote('severe_comorbidities')}</div></div>
